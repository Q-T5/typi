...
<template>
    <div class="flex">
        <div class="flex flex-col w-1/3 justify-center px-2 space-y-2">
            <div class="controls-div flex flex-col">
                <h1 class="text-center text-xl">Controls</h1>
...
import { sentence, addNouns } from 'txtgen'
...
export default {
    ...
    setup: function() {
        ...
        function generate() {
            baseSentence.value = sentence().addNouns([
                "cat", "dog", "mouse"
            ]);
        }
        ...
        return {
            ...
            words, userInput, baseSentence, preventErase, disableErasure
        }
    }
}
</script>